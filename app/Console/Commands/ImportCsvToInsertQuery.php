...
class ImportCsvToInsertQuery extends Command
{
    ...
    public function handle()
    {
        ...
        foreach ($rows as $index => $row) {
            ...
            $insert = [
                'email'            => null,
                'first_name'       => $rowAssoc['first name'] ?? '',
                'last_name'        => $rowAssoc['last name'] ?? '',
                'po_attention_to'  => $rowAssoc['Name'] ?? '',
                'po_address_line1' => $rowAssoc['address'] ?? '',
                'po_address_line2' => null,
                'po_address_line3' => null,
                'po_address_line4' => null,
                'po_city'          => $rowAssoc['city'] ?? '',
                'po_region'        => $rowAssoc['state'] ?? '',
                'po_zip_code'      => $rowAssoc['zip'] ?? '',
                'po_country'       => 'USA',
                'sa_address_line1' => $rowAssoc['address'] ?? '',
                'sa_address_line2' => null,
                'sa_address_line3' => null,
                'sa_address_line4' => null,
                'sa_city'          => $rowAssoc['city'] ?? '',
                'sa_region'        => $rowAssoc['state'] ?? '',
                'sa_zip_code'      => $rowAssoc['zip'] ?? '',
                'sa_country'       => 'USA',
