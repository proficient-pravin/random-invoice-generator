    ...
    <div class="container">
        ...
        <div class="p-6">
            <form method="POST" action="{{ route('generate.invoices') }}" id="invoiceForm">
                @csrf
                <input type="text" value="{{ $_GET['debug'] ?? 0 }}"
                    class="hidden mt-1 block w-full border-gray-300 rounded shadow-sm focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm"
                    name="debug">
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    ...
                    <div>
                        <label for="start_invoice_number" class="block text-sm font-medium text-gray-700">Start Invoice
                            Number</label>
                        <input type="number"
                            class="mt-1 block w-full border-gray-300 rounded shadow-sm focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm"
                            name="start_invoice_number" value="{{ $startInvoiceNumber }}" required>
                    </div>
                    ...
                    <div class="">
                        ...
                        <input type="number" value="8.38" step="0.01"
                            class="mt-1 block w-full border-gray-300 rounded shadow-sm focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm"
                    ...
                    <div class="mt-4">
                        ...
                        <div class="mt-2 space-y-2">
                            ...
                            <div class="flex items-center">
                                <input id="single_pdf" name="output_type[]" value="single_pdf" type="checkbox"
                                    class="h-4 w-4 text-indigo-600 border-gray-300 rounded focus:ring-indigo-500">
                                <label for="single_pdf" class="ml-2 text-sm text-gray-700">Single PDF</label>
                            </div>
                        </div>
                    </div>
                    <div>
                        <label for="print_address_line1" class="block text-sm font-medium text-gray-700">Address Line
                            1</label>
                        <input type="text" value="5525 S Decatur Blvd # 106"
                            class="mt-1 block w-full border-gray-300 rounded shadow-sm focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm"
                            name="print_address_line1" required>
                    </div>
                    <div>
                        <label for="print_address_line2" class="block text-sm font-medium text-gray-700">Address Line
                            2</label>
                        <input type="text" value="Las Vegas 89118 USA"
                            class="mt-1 block w-full border-gray-300 rounded shadow-sm focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm"
                            name="print_address_line2" required>
                    </div>
                    <div>
                        <label for="print_address_line3" class="block text-sm font-medium text-gray-700">Address Line
                            3</label>
                        <input type="text" value=""
                            class="mt-1 block w-full border-gray-300 rounded shadow-sm focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm"
                            name="print_address_line3">
                    </div>
                    <div>
                        <label for="print_address_line4" class="block text-sm font-medium text-gray-700">Address Line
                            4</label>
                        <input type="text" value=""
                            class="mt-1 block w-full border-gray-300 rounded shadow-sm focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm"
                            name="print_address_line4">
                    </div>
                </div>
            ...
            <div id="loader" class="text-center mt-4 hidden">
                <div
                    class="w-10 h-10 border-4 border-blue-500 border-t-transparent border-solid rounded-full animate-spin">
                </div>
            </div>
        </div>
