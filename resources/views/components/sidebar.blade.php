<aside :class="sidebarToggle ? 'translate-x-0' : '-translate-x-full'"
    ...
    <div class="flex items-center justify-between gap-2 px-6 py-5.5 lg:py-6.5">
        <a href="index.html">
            <img src="{{ asset('702logo.png') }}" alt="Logo" />
        </a>
    ...
    <div class="no-scrollbar flex flex-col overflow-y-auto duration-300 ease-linear">
        ...
        <nav class="mt-5 px-4 py-4 lg:mt-9 lg:px-6" x-data="{ selected: $persist('Dashboard') }">
            <div>
                <ul class="space-y-2 font-medium text">
                    <li>
                        <a href="/"
                            class="flex items-center p-2 text-white rounded-lg dark:text-white hover:bg-gray-700 hover:text-white group">
                    ...
                    @if (auth()->user()?->isAdmin())
                        <li>
                            <a href="{{ route('invoices.generate') }}"
                                ...
                                <span class="ms-3">Generate Invoices</span>
                            </a>
                        </li>
                    @endif
                    <li>
                    ...
                    <li>
                        <a href="{{ route('products.index') }}"
                            ...
                            <svg class="flex-shrink-0 w-5 h-5 text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white"
                                ...
                                viewBox="0 0 18 20">
                                <path
                                    d="M17 5.923A1 1 0 0 0 16 5h-3V4a4 4 0 1 0-8 0v1H2a1 1 0 0 0-1 1v13a1 1 0 0 0 1 1h14a1 1 0 0 0 1-1V5a1 1 0 0 0-1-1Zm-9-1a2 2 0 1 1 4 0v1H8V4ZM3 6h12v12H3V6Z" />
                            </svg>
