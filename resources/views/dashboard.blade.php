    ...
    <main>
        <div class="mx-auto">
            ...
            <div class="mt-4 grid grid-cols-12 gap-4 md:mt-6 md:gap-6 2xl:mt-7.5 2xl:gap-7.5">
                <!-- ====== Chart One Start -->
                @include('components.charts.chart-1')
                @include('components.charts.chart-02')
                @include('components.charts.chart-03')
                @include('components.charts.chart-04')
                ...
                <div class="col-span-12">
                    {{-- <div class="col-span-3 xl:col-span-3">
                            @include('components.tables.table-01')
                        </div> --}}
                    <div class="col-span-3 xl:col-span-3">
                        @include('components.tables.table-02')
                    </div>
                    {{-- <div class="col-span-3 xl:col-span-3">
                            @include('components.tables.table-03')
                        </div> --}}
                </div>
                <!-- ====== Table One End -->
