...
<div class="container mx-auto p-6">
    <h1 class="text-2xl font-semibold text-gray-700 mb-6">Add Customer</h1>
        ...
        <div class="mt-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div class="mb-4">
                    ...
                    <input type="text" name="po_address_line1" id="po_address_line1" value="{{ old('po_address_line1') }}"
                ...
                <div class="mb-4">
                    ...
                    <input type="text" name="po_address_line2" id="po_address_line2" value="{{ old('po_address_line2') }}"
                ...
                <div class="mb-4">
                    ...
                    <input type="text" name="po_address_line3" id="po_address_line3" value="{{ old('po_address_line3') }}"
                ...
                <div class="mb-4">
                    ...
                    <input type="text" name="po_address_line4" id="po_address_line4" value="{{ old('po_address_line4') }}"
        ...
        <div class="mt-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div class="mb-4">
                    ...
                    <input type="text" name="sa_address_line1" id="sa_address_line1" value="{{ old('sa_address_line1') }}"
                ...
                <div class="mb-4">
                    ...
                    <input type="text" name="sa_address_line2" id="sa_address_line2" value="{{ old('sa_address_line2') }}"
                ...
                <div class="mb-4">
                    ...
                    <input type="text" name="sa_address_line3" id="sa_address_line3" value="{{ old('sa_address_line3') }}"
                ...
                <div class="mb-4">
                    ...
                    <input type="text" name="sa_address_line4" id="sa_address_line4" value="{{ old('sa_address_line4') }}"
