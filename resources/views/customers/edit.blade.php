            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div class="mb-4">
                    ...
                    <select name="tag_id" id="tag_id"
                        ...
                        @foreach ($tags as $tag)
                            <option value="{{ $tag->id }}"
                                {{ old('tag_id', $customer->tag_id) == $tag->id ? 'selected' : '' }}>
                                {{ $tag->name }}
                            </option>
                        @endforeach
                    </select>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div class="mb-4">
                        ...
                        <input type="text" name="po_address_line1" id="po_address_line1"
                            value="{{ old('po_address_line1', $customer->po_address_line1) }}"
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" name="po_address_line2" id="po_address_line2"
                            value="{{ old('po_address_line2', $customer->po_address_line2) }}"
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" name="po_address_line3" id="po_address_line3"
                            value="{{ old('po_address_line3', $customer->po_address_line3) }}"
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" name="po_address_line4" id="po_address_line4"
                            value="{{ old('po_address_line4', $customer->po_address_line4) }}"
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" name="po_city" id="po_city"
                            value="{{ old('po_city', $customer->po_city) }}"
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" name="po_region" id="po_region"
                            value="{{ old('po_region', $customer->po_region) }}"
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" name="po_zip_code" id="po_zip_code"
                            value="{{ old('po_zip_code', $customer->po_zip_code) }}"
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" name="po_country" id="po_country"
                            value="{{ old('po_country', $customer->po_country) }}"
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div class="mb-4">
                        ...
                        <input type="text" name="sa_address_line1" id="sa_address_line1"
                            value="{{ old('sa_address_line1', $customer->sa_address_line1) }}"
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" name="sa_address_line2" id="sa_address_line2"
                            value="{{ old('sa_address_line2', $customer->sa_address_line2) }}"
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" name="sa_address_line3" id="sa_address_line3"
                            value="{{ old('sa_address_line3', $customer->sa_address_line3) }}"
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" name="sa_address_line4" id="sa_address_line4"
                            value="{{ old('sa_address_line4', $customer->sa_address_line4) }}"
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" name="sa_city" id="sa_city"
                            value="{{ old('sa_city', $customer->sa_city) }}"
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" name="sa_region" id="sa_region"
                            value="{{ old('sa_region', $customer->sa_region) }}"
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" name="sa_zip_code" id="sa_zip_code"
                            value="{{ old('sa_zip_code', $customer->sa_zip_code) }}"
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" name="sa_country" id="sa_country"
                            value="{{ old('sa_country', $customer->sa_country) }}"
